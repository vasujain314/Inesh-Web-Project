    ...
    <head>
    <meta charset="utf-8">
    <title>Inesh | Refund Policy</title>
       ...
       <div id="header1"></div>
            <div class="container" style="margin-top: 3rem;">
                <div class="section-title" style="margin-bottom: 4rem;">
                            <h2 class="text-center" style="font-size:3.2rem">Refund Policy</h2>
                        </div>
                <div class="row">
                    <div class="col-sm-12">
         ...
         <div class="section-title" style="margin-bottom: 4rem;">
                  ...
                  <p class="text-center">We guarantee your complete satisfaction on every service we render, if after taking a service client wants to cancel it we assure to provide 100% refund of the paid amount if the return request is raised within 10 days of purchasing the services.
<br/>
Any deliverable/content that will be accepted and paid for is excluded from any type of refund.
Any request that will be made after 10 days of payment is excluded. Inesh cannot issue a refund unless the request for cancellation is made within 10 days of payment.
<br/>
