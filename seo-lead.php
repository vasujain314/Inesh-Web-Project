...
<div class="row">
     <div class="section-title" style="margin-bottom: 4rem;">
               ...
               <div class="container" >
                <p class=" text-center">
                <!-- In order to get organic traffic, you need to be seen on early pages of search engine. And for good ranks one needs a perfectly strategized work on your website where team of Inesh acts as a catalyst to build the right strategy, to make the content according to your business and to choose the right keywords. -->
                  <?php 
                      include("connect.php");
                      $sql = 'SELECT * from `seo_overview`';
                      $result = $conn->query($sql);
...
You can easily check your site’s loading speed using the excellent GTMetrix.com tool </p>
    ...
    <div class="container" style="overflow-x: auto;">
      ...
      <div class="row">
          <div class="col-xs-10 col-xs-offset-1">
              <h3 style="color: black; margin-top: 20px; margin-bottom: 20px;">Social Media Marketing (Per Month)</h3>
              <table class=" text-center table table-responsive">
                <thead style="background-color:#E13737; color:white; font-size:1.5rem; padding: 10px;" >
                      <tr>
                          <th class="text-center" width="28%">Services</th>
                  ...
                  <tbody>
                      <tr>
                          <td width="28%" class="font-weight-bold">Social Media Profile Creation</td>
                          <td width="14%"><span class="fa fa-check"></span></td>
                          <td width="14%"><span class="fa fa-check"></span></td>
                          <td width="14%"><span class="fa fa-check"></span></td>
                          <td width="14%"><span class="fa fa-check"></span></td>
                      ...
                      <tr>
                          <td class="font-weight-bold">Google+ Profile Promotion</td>
                          <td width="14%"><span class="fa fa-times"></span></td>
                          <td width="14%">10</td>
                          <td width="14%">15</td>
                          <td width="14%">20</td>
                      ...
                      <tr>
                          <td class="font-weight-bold">Instagram Profile Promotion</td>
                          <td width="14%"><span class="fa fa-times"></span></td>
                          <td width="14%">10</td>
                          <td width="14%">15</td>
                          <td width="14%">20</td>
                      ...
                      <tr>
                          <td class="font-weight-bold">Pinterest Profile Promotion</td>
                          <td width="14%"><span class="fa fa-times"></span></td>
                          <td width="14%">10</td>
                          <td width="14%">15</td>
                          <td width="14%">20</td>
      ...
      <div class="row">
          <div class="col-xs-10 col-xs-offset-1">
              <h3 style="color: black; margin-top: 20px; margin-bottom: 20px;">Monthly Reports</h3>
              <table class=" text-center table table-responsive">
                <thead style="background-color:#E13737; color:white; font-size:1.5rem; padding: 10px;" >
                      <tr>
                          <th class="text-center" width="28%">Services</th>
                  ...
                  <tbody>
                    <tr>
                      <td width="28%" class="font-weight-bold">Monthly Keyword Rank Report</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Monthly SEO Work Report</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Social Network Report</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Google Analytics Report</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Monthly Activity Report</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
      ...
      <div class="row">
          <div class="col-xs-10 col-xs-offset-1">
              <h3 style="color: black; margin-top: 20px; margin-bottom: 20px;">Support</h3>
              <table class=" text-center table table-responsive">
                <thead style="background-color:#E13737; color:white; font-size:1.5rem; padding: 10px;" >
                      <tr>
                          <th class="text-center" width="28%">Services</th>
                  ...
                  <tbody>
                    <tr>
                      <td width="28%" class="font-weight-bold">Phone Support</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Chat Support</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                    ...
                    <tr>
                      <td width="28%" class="font-weight-bold">Email Support</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
      ...
      <div class="row">
          <div class="col-xs-10 col-xs-offset-1">
              <h3 style="color: black; margin-top: 20px; margin-bottom: 20px;">Level Of Personalized Attention</h3>
              <table class=" text-center table table-responsive">
                <thead style="background-color:#E13737; color:white; font-size:1.5rem; padding: 10px;" >
                      <tr>
                          <th class="text-center" width="28%">Services</th>
                  ...
                  <tbody>
                    <tr>
                      <td width="28%" class="font-weight-bold">Dedicated Account Manager</td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
                      <td width="14%"><span class="fa fa-check"></span></td>
